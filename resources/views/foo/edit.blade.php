        ...
        <div class="container">
            <div class="columns">
                <div class="column is-12">
                    <form method="POST" action="{{ route('foo.update', $foo) }}">
                        @csrf
												@method('PUT')
                        <div class="card">
                                    ...
                                    <div class="field">
                                        ...
                                        <div class="control">
                                            <textarea
                                                ...
                                                type="text"
                                                rows="1"
                                                placeholder="Name of the foo...">{{ $foo->name }}</textarea>
                                        </div>
                                        @error('name')
                                    ...
                                    <div class="field">
                                        ...
                                        <div class="control">
                                            <textarea
                                                ...
                                                type="number"
                                                rows="1"
                                                placeholder="A positive number...">{{ $foo->thud }}</textarea>
                                        </div>
                                        @error('thud')
                                        <p class="help is-danger">{{ $message }}</p>
                                        @enderror
                                    ...
                                    <div class="field">
                                        ...
                                        <div class="control">
                                            <textarea
                                                ...
                                                rows="1"
                                                placeholder="The wombat...">{{ $foo->wombat }}</textarea>
                                        </div>
                                        @error('wombat')
                                        <p class="help is-danger">{{ $message }}</p>
                                        @enderror
